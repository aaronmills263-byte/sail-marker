...
export function TheMooringsWidget({ destinationSlug, className = "" }: Props) {
  const href = "#"; // Placeholder until CJ approval
  ...
  return (
    <div className={`rounded-xl border border-navy-100 bg-white p-5 ${className}`}>
      ...
      <p className="text-sm text-navy-600 mb-4">
        Premium yacht charters with legendary service. Bareboat, crewed, and power.
      </p>
      <a
        href={href}
        target="_blank"
